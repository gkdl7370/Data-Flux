...
100,000행 × 24 DataPoint = 2,400,000건 / Batch size 1,000 기준

| 측정 항목 | Legacy (List + JPA Save) | **Data-Flux (Chunk + JDBC)** | **개선율** |
| :--- | :--- | :--- | :--- |
| **메모리 점유** | 1GB+ (OOM 위험) | **100MB 미만 (일정 유지)** | ** 90% 절감** |
| **적재 시간** | 120초 | **12초** | ** 약 10배 가속** |
| **I/O 횟수** | 2,400,000회 (건별 통신) | **2,400회 (Batch 1,000 기준)** | ** 1,000배 감소** |
| **가용성** | 에러 시 전체 중단 | **Skip/Retry 정책 적용** | ** 무중단 처리 가능** |
---
